const savedContent = [
  {
    ...
    imageUrl: `/images/desktop/desktop-image-hero-1.jpg`,
  ...
  },
  {
    ...
    imageUrl: `/images/desktop/desktop-image-hero-2.jpg`,
    content: `With stores all over the world, it's easy for you to find
    furniture for your home or place of business. Locally, we’re in most major cities throughout the
    country. Find the branch nearest you using our store locator. Any questions? Don't hesitate to
    contact us today.`,
  },
  {
    title: 'Manufactured with the best materials',
    imageUrl: `/images/desktop/desktop-image-hero-3.jpg`,
...
// NOTE we are trying to fetch images and text Content so we applied a script tag with this file name temporary!
